        ...
        return (
            <Container>
                ...
                <div>
                    ...
                    <a href="https://healthgram.ca" target="_blank"><img src={healthgram} style={{border : "4px"}} className="thumbnail"/> </a> 
                </div>
                <div>
                    <h2>Food XDev</h2>
                    <p> This is my food and drink related blog.</p>
                    <a href="https://foodxdev.com" target="_blank"> <img src={foodxdev} style={{border : "4px"}} className="thumbnail"/></a>
                </div>
                <div>
                    <h2>XChange</h2>
                ...
                <div>
                    ...
                    <a href="https://hourtech.ca" target="_blank"> <img src={hourtech} style={{border : "4px"}} className="thumbnail"/></a>
                </div>
                </Container>
                <Footer />
            </Container>
